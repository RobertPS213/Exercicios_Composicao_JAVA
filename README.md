# Exercícios de Composição e Lógica (Java)

Repositório criado para consolidar o aprendizado em **Programação Orientada a Objetos (POO)** e **Lógica de Programação**, desenvolvidos durante o curso de JAVA.

## Tecnologias e Conceitos Aplicados
- **Linguagem:** Java (JDK 17+)
- **Conceitos de POO:** Composição de Objetos, Encapsulamento, Enumerações.
- **Estruturas de Dados:** Listas Dinâmicas (`ArrayList`), Manipulação de Strings (`StringBuilder`, `equalsIgnoreCase`).
- **Arquitetura:** Divisão em camadas (`application` para execução e `entities` para modelos de dados).
